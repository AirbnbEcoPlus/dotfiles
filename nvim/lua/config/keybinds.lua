...
map("n", "<leader>j", "<Cmd>BufferMovePrevious<CR>", { desc = "move the buffer at left" })
map("n", "<leader>k", "<Cmd>BufferMoveNext<CR>", { desc = "move the buffer at right" })
...
map("n", "<leader>f", "<cmd>lua vim.lsp.buf.format()<CR>", { desc = "format a file" })

map("n", "<leader>g", "<cmd>lua require('dapui').toggle()<CR>", {desc = "Open DapUI"})
